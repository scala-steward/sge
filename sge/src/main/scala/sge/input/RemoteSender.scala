...
class RemoteSender(ip: String, port: Int)(using Sge) extends InputProcessor {
  ...
  override def keyDown(keycode: Key): Boolean = scala.util.boundary {
    this.synchronized {
  ...
  override def keyUp(keycode: Key): Boolean = scala.util.boundary {
    this.synchronized {
      if (!connected) scala.util.boundary.break(false)
    }
  ...
  override def touchDown(x: Pixels, y: Pixels, pointer: Int, button: Button): Boolean = scala.util.boundary {
    this.synchronized {
      if (!connected) scala.util.boundary.break(false)
    }
  ...
  override def touchUp(x: Pixels, y: Pixels, pointer: Int, button: Button): Boolean = scala.util.boundary {
    this.synchronized {
      if (!connected) scala.util.boundary.break(false)
    }
  ...
  override def touchDragged(x: Pixels, y: Pixels, pointer: Int): Boolean = scala.util.boundary {
    this.synchronized {
      if (!connected) scala.util.boundary.break(false)
    }
  ...
  override def mouseMoved(x: Pixels, y: Pixels): Boolean =
    false
