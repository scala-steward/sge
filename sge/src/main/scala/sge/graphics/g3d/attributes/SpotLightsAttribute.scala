 ...
 * Covenant-baseline-methods: Alias,SpotLightsAttribute,Type,compare,copy,hashCode,is,lights,result,this
 * Covenant-source-reference: com/badlogic/gdx/graphics/g3d/attributes/SpotLightsAttribute.java
