...
class MeshPart {
  ...
  def this(id: Nullable[String], mesh: Mesh, offset: Int, size: Int, primitiveType: PrimitiveMode) = {
    this()
  ...
  /** Set this MeshPart to given values, does not {@link #update()} the bounding box values.
    ...
    *   this MeshPart, for chaining.
    */
  def set(id: Nullable[String], mesh: Mesh, offset: Int, size: Int, primitiveType: PrimitiveMode): MeshPart = {
    this.id = id
    this.mesh = mesh
    this.offset = offset
    this.size = size
