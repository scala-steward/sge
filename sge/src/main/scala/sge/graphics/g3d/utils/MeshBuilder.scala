 ...
 *   - Deprecated shape builder delegate methods deleted (no external users; use ShapeBuilder objects directly)
 ...
 * Covenant-baseline-loc: 826
 * Covenant-baseline-methods: MAX_INDEX,MAX_VERTICES,MeshBuilder,_attributes,_lastIndex,_primitiveType,a,aBiNor,aCol,aCp,aNor,aTangent,aUv,addMesh,addVertex,arr,attributes,attrs,begin,biNorOffset,bounds,clear,colOffset,colSize,color,cpOffset,createAttributes,end,endpart,ensureCapacity,ensureIndices,ensureRectangleIndices,ensureTriangleIndices,ensureVertices,floatsPerVertex,getIndices,getIndicesArray,getVertexTransform,getVertices,getVerticesArray,hasColor,hasUVTransform,i,index,indices,indicesMap,isVertexTransformationEnabled,istart,lastIndex,line,meshPart,n,norOffset,normalTransform,numIndices,numVertices,o,offset,part,parts,posOffset,posSize,positionTransform,primitiveType,rect,setColor,setUVRange,setVertexTransform,setVertexTransformationEnabled,stride,tangentOffset,tempC1,tmpIndices,tmpNormal,tmpVertices,transformNormal,transformPosition,triangle,uOffset,uScale,uvOffset,v,vOffset,vScale,vTmp,vertTmp1,vertTmp2,vertTmp3,vertTmp4,vertex,vertexTransformationEnabled,vertices,vindex,x,y,z
