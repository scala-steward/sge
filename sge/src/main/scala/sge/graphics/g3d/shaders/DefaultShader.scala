 ...
 * Covenant-baseline-loc: 1902
 * Covenant-baseline-methods: ACubemap,Bones,Config,DefaultShader,Inputs,Setters,_combinedAttributes,_renderable,alphaTest,ambientCube,ambientCubemap,ambientTexture,ambientUVTransform,and,arr,attributes,attributesMask,begin,bindLights,bindMaterial,boneWeights,boneWeightsLocations,bones,cameraDirection,cameraNearFar,cameraPosition,cameraUp,canRender,close,combineAttributeMasks,combineAttributes,compareTo,config,createPrefix,cullFace,defaultCullFace,defaultCullFace_,defaultDepthFunc,defaultDepthFunc_,defaultFragmentShader,defaultVertexShader,depthFunc,depthMask,depthRangeFar,depthRangeNear,diffuseColor,diffuseTexture,diffuseUVTransform,dirLights,dirLightsColorOffset,dirLightsDirectionOffset,dirLightsLoc,dirLightsSize,directionalLights,dirs,dla,emissiveColor,emissiveTexture,emissiveUVTransform,end,environmentCubemap,equals,fragmentShader,i,ignoreUnimplemented,implementedFlags,init,lighting,lights,lightsSet,mask,n,normalMatrix,normalTexture,normalUVTransform,numBoneWeights,numBones,numDirectionalLights,numPointLights,numSpotLights,opacity,optionalAttributes,or,pla,pointLights,pointLightsColorOffset,pointLightsIntensityOffset,pointLightsLoc,pointLightsPositionOffset,pointLightsSize,points,prog,projTrans,projViewTrans,projViewWorldTrans,reflectionColor,reflectionTexture,reflectionUVTransform,render,sb,set,shadowMap,shininess,sla,specularColor,specularTexture,specularUVTransform,spotLights,spotLightsColorOffset,spotLightsCutoffAngleOffset,spotLightsDirectionOffset,spotLightsExponentOffset,spotLightsIntensityOffset,spotLightsLoc,spotLightsPositionOffset,spotLightsSize,spots,textureCoordinates,this,time,tmpAttributes,u_alphaTest,u_ambientCubemap,u_ambientTexture,u_ambientUVTransform,u_bones,u_cameraDirection,u_cameraNearFar,u_cameraPosition,u_cameraUp,u_diffuseColor,u_diffuseTexture,u_diffuseUVTransform,u_dirLights0color,u_dirLights0direction,u_dirLights1color,u_emissiveColor,u_emissiveTexture,u_emissiveUVTransform,u_environmentCubemap,u_fogColor,u_normalMatrix,u_normalTexture,u_normalUVTransform,u_opacity,u_pointLights0color,u_pointLights0intensity,u_pointLights0position,u_pointLights1color,u_projTrans,u_projViewTrans,u_projViewWorldTrans,u_reflectionColor,u_reflectionTexture,u_reflectionUVTransform,u_shadowMapProjViewTrans,u_shadowPCFOffset,u_shadowTexture,u_shininess,u_specularColor,u_specularTexture,u_specularUVTransform,u_spotLights0color,u_spotLights0cutoffAngle,u_spotLights0direction,u_spotLights0exponent,u_spotLights0intensity,u_spotLights0position,u_spotLights1color,u_time,u_viewTrans,u_viewWorldTrans,u_worldTrans,vertexMask,vertexShader,viewTrans,viewWorldTrans,worldTrans
 * Covenant-source-reference: com/badlogic/gdx/graphics/g3d/shaders/DefaultShader.java
 * Covenant-verified: 2026-04-19
 *
 * upstream-commit: 723fded82de0b0d78b3a7bcfae2a8ac56af8fd7a
 */
package sge
package graphics
package g3d
