 ...
 * Original source: com/badlogic/gdx/graphics/g3d/particles/renderers/BillboardControllerRenderData.java
 ...
 * Covenant-baseline-methods: BillboardControllerRenderData,colorChannel,regionChannel,rotationChannel,scaleChannel
 * Covenant-source-reference: com/badlogic/gdx/graphics/g3d/particles/renderers/BillboardControllerRenderData.java
...
/** Render data used by billboard particle batches
  ...
  *   Inferno
  */
class BillboardControllerRenderData extends ParticleControllerRenderData {
