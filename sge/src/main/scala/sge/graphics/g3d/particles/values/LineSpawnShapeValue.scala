 ...
 * Covenant-baseline-methods: LineSpawnShapeValue,a,copy,depth,height,spawnAux,this,width
 * Covenant-source-reference: com/badlogic/gdx/graphics/g3d/particles/values/LineSpawnShapeValue.java
