 ...
 * Covenant-baseline-loc: 1535
 * Covenant-baseline-methods: GradientColorValue,IndependentScaledNumericValue,NumericValue,Particle,ParticleEmitter,ParticleValue,RangedNumericValue,ScaledNumericValue,SpawnEllipseSide,SpawnShape,SpawnShapeValue,SpriteMode,UPDATE_ANGLE,UPDATE_GRAVITY,UPDATE_ROTATION,UPDATE_SCALE,UPDATE_SPRITE,UPDATE_TINT,UPDATE_VELOCITY,UPDATE_WIND,_active,_activeCount,_bounds,_imagePaths,_maxParticleCount,_motionValues,_particles,_sprites,_x,_xSizeValues,_y,_ySizeValues,accumulator,activateParticle,active,activeCount,actualCount,addParticle,addParticles,additive,aligned,allowCompletion,allowCompletionMethod,alwaysActive,angle,angleCos,angleDiff,angleSin,angleValue,attached,behind,boundingBox,calculateColor,cleansUpBlendFunction,color,colors,continuous,copyValue,currentLife,delay,delayTimer,delayVal,delayValue,deltaMillis,draw,duration,durationTimer,durationVal,durationValue,edges,emission,emissionDelta,emissionDiff,emissionTime,emissionVal,emissionValue,firstUpdate,flipX,flipY,flipYValues,frame,generateLifeOffsetValues,generateLifeValues,getColor,getScale,gravity,gravityDiff,gravityValue,highMax,highMin,i,imagePaths,imagePaths_,independent,index,initialize,isActive,isComplete,life,lifeDiff,lifeOffset,lifeOffsetDiff,lifeOffsetVal,lifeOffsetValue,lifeVal,lifeValue,line,load,lowMax,lowMin,matchMotion,matchSize,matchXSize,matchYSize,maxParticleCount,maxParticleCount_,minParticleCount,motionValues,n,name,newHighValue,newLowValue,newParticle,offsetTime,particle,particleRotation,particles,percent,percentComplete,preAllocateParticles,premultipliedAlpha,readBoolean,readFloat,readInt,readString,relative,reset,restart,rotation,rotationDiff,rotationValue,save,scale,scaleMotion,scaleSize,scaling,set,setFlip,setHigh,setLow,setPosition,setSprites,shape,side,spawnHeight,spawnHeightDiff,spawnHeightVal,spawnHeightValue,spawnShape,spawnShapeValue,spawnWidth,spawnWidthDiff,spawnWidthVal,spawnWidthValue,sprite,spriteHeight,spriteMode,spriteVal,spriteWidth,sprites,start,temp,templateValues,this,timeline,tint,tintValue,transparency,transparencyDiff,transparencyValue,update,updateFlags,updateParticle,value,values,velocity,velocityDiff,velocityValue,wind,windDiff,windValue,x,xOffset,xOffsetValue,xScale,xScaleDiff,xScaleValue,xSizeValues,y,yOffset,yOffsetValue,yScale,yScaleDiff,yScaleValue,ySizeValues
 * Covenant-source-reference: com/badlogic/gdx/graphics/g2d/ParticleEmitter.java
