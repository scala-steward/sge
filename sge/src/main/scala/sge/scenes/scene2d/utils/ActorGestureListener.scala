...
class ActorGestureListener(halfTapSquareSize: Float, tapCountInterval: Float, longPressDuration: Float, maxFlingDelay: Float)(using Sge) extends EventListener {
  ...
  private val detector: GestureDetector = GestureDetector(
    ...
    new GestureDetector.GestureAdapter {
      ...
      override def tap(stageX: Float, stageY: Float, count: Int, button: Button): Boolean = {
        _actor.foreach { a =>
      ...
      override def panStop(stageX: Float, stageY: Float, pointer: Int, button: Button): Boolean = {
        _actor.foreach { a =>
          a.stageToLocalCoordinates(tmpCoords.set(stageX, stageY))
  ...
  def touchDown(event: InputEvent, x: Float, y: Float, pointer: Int, button: Button): Unit = {}

  def touchUp(event: InputEvent, x: Float, y: Float, pointer: Int, button: Button): Unit = {}

  def tap(event: InputEvent, x: Float, y: Float, count: Int, button: Button): Unit = {}
  ...
  def fling(event: InputEvent, velocityX: Float, velocityY: Float, button: Button): Unit = {}
  ...
  def panStop(event: InputEvent, x: Float, y: Float, pointer: Int, button: Button): Unit = {}
