 ...
 * Covenant-baseline-loc: 1296
 * Covenant-baseline-methods: BACKSPACE,BULLET,CARRIAGE_RETURN,DEFAULT_ONSCREEN_KEYBOARD,DELETE,DefaultOnscreenKeyboard,DigitsOnlyFilter,KeyRepeatTask,NEWLINE,NativeOnscreenKeyboard,OnscreenKeyboard,TAB,TextField,TextFieldClickListener,TextFieldFilter,TextFieldListener,TextFieldStyle,_disabled,_focusTraversal,_messageText,_programmaticChangeEvents,_selectionStart,_style,_text,acceptChar,adjustedX,alignment,appendText,autocompleteOptions,background,backgroundDrawable,bestCoords,bgLeftWidth,bgRightWidth,blinkTask,blinkTime,buffer,c,calculateOffsets,changeText,charOffset,checkFocusTraversal,clearSelection,clicked,clipboard,close,color,continue,continueCursor,copy,createInputListener,current,currentBest,currentCoords,cursor,cursorOn,cursorPatch,cursorPosition,cut,data,defaultInputListener,delete,disabled,disabledBackground,disabledFontColor,disabled_,displayText,distance,draw,drawBackground,drawCursor,drawMessageText,drawSelection,drawText,end,endX,filter,findNextTextField,focused,focusedBackground,focusedFontColor,font,fontColor,fontOffset,from,getFocusTraversal,getMaxLength,getProgrammaticChangeEvents,getSelectionStart,getTextY,glyphCount,glyphLayout,glyphPositions,goEnd,goHome,hasSelection,height,i,index,initialize,inputListener,insert,isPasswordMode,isWordCharacter,keyDown,keyRepeatInitialTime,keyRepeatTask,keyRepeatTime,keyTyped,keyUp,keyboard,keyboardType,keycode,lastChangeTime,left,letterUnderCursor,limit,listener,markupEnabled,maxIndex,maxLength,maxOffset,messageFont,messageFontColor,messageText,minHeight,minIndex,moveCursor,n,newDisplayText,newText,next,onClose,onlyFontChars,onscreenKeyboard,openNativeInputField,passwordBuffer,passwordCharacter,passwordMode,paste,prefHeight,prefWidth,preventAutoCorrection,renderOffset,right,run,s,scheduleKeyRepeatTask,se,selectAll,selection,selectionEnd,selectionStart,selectionWidth,selectionX,setAlignment,setAutocompleteOptions,setBlinkTime,setClipboard,setCursorPosition,setFocusTraversal,setKeyboardType,setMaxLength,setMessageText,setOnlyFontChars,setOnscreenKeyboard,setPasswordCharacter,setPasswordMode,setPreventAutoCorrection,setProgrammaticChangeEvents,setSelection,setStyle,setText,setTextFieldFilter,setTextFieldListener,show,ss,startX,stg,style,text,textFieldFilter,textHAlign,textHeight,textLength,textOffset,textY,th,this,tmp1,tmp2,tmp3,to,topAndBottom,touchDown,touchDragged,touchUp,tw,tx,ty,undoText,updateDisplayText,visibleTextEnd,visibleTextStart,visibleWidth,width,withinMaxLength,wordUnderCursor,writeEnters,writeResults,x,yOffset
 * Covenant-source-reference: com/badlogic/gdx/scenes/scene2d/ui/TextField.java
 * Covenant-verified: 2026-04-19
 *
 * upstream-commit: 5a27a92e68913c6a909fd8004457afbb6cca0fc7
 */
package sge
package scenes
package scene2d
...
/** A single-line text input field. <p> The preferred height of a text field is the height of the {@link TextFieldStyle#font} and {@link TextFieldStyle#background}. The preferred width of a text field
  ...
  * functionality is provided via the {@link Clipboard} interface. Currently there are two standard implementations, one for the desktop and one for Android. The Android clipboard is a no-op, as copy
  ...
  * the text field. There are two standard implementations, one for the desktop and one for Android. The desktop keyboard is a no-op, as a softkeyboard is not needed on the desktop. The Android
