 ...
 * Covenant-baseline-methods: RunnableAction,act,ran,reset,restart,run,runnable,savedPool
 * Covenant-source-reference: com/badlogic/gdx/scenes/scene2d/actions/RunnableAction.java
