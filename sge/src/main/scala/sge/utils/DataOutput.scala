 ...
 * Covenant-baseline-methods: DataOutput,charCount,charIndex,i,v,writeInt,writeString,writeString_slow
 * Covenant-source-reference: com/badlogic/gdx/utils/DataOutput.java
