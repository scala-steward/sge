...
class AngleGL30Native extends AngleGL20Native with GL30 {
  ...
  override def glDrawRangeElements(mode: PrimitiveMode, start: Int, end: Int, count: Int, `type`: DataType, indices: Buffer): Unit =
    GL30C.glDrawRangeElements(mode.toInt, start, end, count, `type`.toInt, bufPtr(indices))

  override def glDrawRangeElements(mode: PrimitiveMode, start: Int, end: Int, count: Int, `type`: DataType, offset: Int): Unit =
    GL30C.glDrawRangeElements(mode.toInt, start, end, count, `type`.toInt, offsetPtr(offset))
  ...
  override def glTexImage3D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, depth: Int, border: Int, format: PixelFormat, `type`: DataType, pixels: Buffer): Unit =
    GL30C.glTexImage3D(target.toInt, level, internalformat, width, height, depth, border, format.toInt, `type`.toInt, bufPtr(pixels))
  ...
  override def glTexImage3D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, depth: Int, border: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    GL30C.glTexImage3D(target.toInt, level, internalformat, width, height, depth, border, format.toInt, `type`.toInt, offsetPtr(offset))
  ...
  override def glTexImage2D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    GL20C.glTexImage2D(target.toInt, level, internalformat, width, height, border, format.toInt, `type`.toInt, offsetPtr(offset))
  ...
  override def glTexSubImage3D(
    ...
    GL30C.glTexSubImage3D(target.toInt, level, xoffset, yoffset, zoffset, width, height, depth, format.toInt, `type`.toInt, bufPtr(pixels))
  ...
  override def glTexSubImage3D(
    ...
    GL30C.glTexSubImage3D(target.toInt, level, xoffset, yoffset, zoffset, width, height, depth, format.toInt, `type`.toInt, offsetPtr(offset))
  ...
  override def glTexSubImage2D(target: TextureTarget, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    GL20C.glTexSubImage2D(target.toInt, level, xoffset, yoffset, width, height, format.toInt, `type`.toInt, offsetPtr(offset))
  ...
  override def glCopyTexSubImage3D(target: TextureTarget, level: Int, xoffset: Int, yoffset: Int, zoffset: Int, x: Int, y: Int, width: Int, height: Int): Unit =
    GL30C.glCopyTexSubImage3D(target.toInt, level, xoffset, yoffset, zoffset, x, y, width, height)
  ...
  override def glUnmapBuffer(target: BufferTarget): Boolean = fromGlBool(GL30C.glUnmapBuffer(target.toInt))
  ...
  override def glBlitFramebuffer(srcX0: Int, srcY0: Int, srcX1: Int, srcY1: Int, dstX0: Int, dstY0: Int, dstX1: Int, dstY1: Int, mask: ClearMask, filter: Int): Unit =
    GL30C.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask.toInt, filter)
  ...
  override def glVertexAttribIPointer(index: Int, size: Int, `type`: DataType, stride: Int, offset: Int): Unit =
    GL30C.glVertexAttribIPointer(index, size, `type`.toInt, stride, offsetPtr(offset))
  ...
  override def glDrawArraysInstanced(mode: PrimitiveMode, first: Int, count: Int, instanceCount: Int): Unit =
    GL30C.glDrawArraysInstanced(mode.toInt, first, count, instanceCount)

  override def glDrawElementsInstanced(mode: PrimitiveMode, count: Int, `type`: DataType, indicesOffset: Int, instanceCount: Int): Unit =
    GL30C.glDrawElementsInstanced(mode.toInt, count, `type`.toInt, offsetPtr(indicesOffset), instanceCount)
  ...
  override def glGetBufferParameteri64v(target: BufferTarget, pname: Int, params: LongBuffer): Unit = GL30C.glGetBufferParameteri64v(target.toInt, pname, bufPtr(params).asInstanceOf[Ptr[CLong]])
