...
class WebGL30(gl2: js.Dynamic) extends WebGL20(gl2) with GL30 {
  ...
  override def glDrawRangeElements(mode: PrimitiveMode, start: Int, end: Int, count: Int, `type`: DataType, indices: Buffer): Unit =
    gl.drawRangeElements(mode.toInt, start, end, count, `type`.toInt, indices.position())

  override def glDrawRangeElements(mode: PrimitiveMode, start: Int, end: Int, count: Int, `type`: DataType, offset: Int): Unit =
    gl.drawRangeElements(mode.toInt, start, end, count, `type`.toInt, offset)
  ...
  override def glTexImage2D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    gl.texImage2D(target.toInt, level, internalformat, width, height, border, format.toInt, `type`.toInt, offset)
  ...
  override def glTexImage3D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, depth: Int, border: Int, format: PixelFormat, `type`: DataType, pixels: Buffer): Unit = {
    val t = target.toInt; val f = format.toInt; val dt = `type`.toInt
    if (pixels == null) {
      gl.texImage3D(t, level, internalformat, width, height, depth, border, f, dt, null)
    } else {
      pixels match {
        case fb: FloatBuffer =>
          gl.texImage3D(t, level, internalformat, width, height, depth, border, f, dt, copy(fb))
        case ib: IntBuffer =>
          val int32 = copy(ib)
          val uint8 = new Uint8Array(int32.buffer, int32.byteOffset, int32.byteLength)
          gl.texImage3D(t, level, internalformat, width, height, depth, border, f, dt, uint8)
        case bb: ByteBuffer =>
          val int8  = copy(bb)
  ...
  override def glTexImage3D(target: TextureTarget, level: Int, internalformat: Int, width: Int, height: Int, depth: Int, border: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    gl.texImage3D(target.toInt, level, internalformat, width, height, depth, border, format.toInt, `type`.toInt, offset)
  ...
  override def glTexSubImage2D(target: TextureTarget, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: PixelFormat, `type`: DataType, offset: Int): Unit =
    gl.texSubImage2D(target.toInt, level, xoffset, yoffset, width, height, format.toInt, `type`.toInt, offset)
  ...
  override def glTexSubImage3D(
    ...
    pixels match {
      case fb: FloatBuffer =>
        gl.texSubImage3D(t, level, xoffset, yoffset, zoffset, width, height, depth, f, dt, copy(fb))
      case ib: IntBuffer =>
        val int32 = copy(ib)
        val uint8 = new Uint8Array(int32.buffer, int32.byteOffset, int32.byteLength)
        gl.texSubImage3D(t, level, xoffset, yoffset, zoffset, width, height, depth, f, dt, uint8)
      case bb: ByteBuffer =>
        val int8  = copy(bb)
        val uint8 = new Uint8Array(int8.buffer, int8.byteOffset, int8.byteLength)
        gl.texSubImage3D(t, level, xoffset, yoffset, zoffset, width, height, depth, f, dt, uint8)
  ...
  override def glTexSubImage3D(
    ...
    gl.texSubImage3D(target.toInt, level, xoffset, yoffset, zoffset, width, height, depth, format.toInt, `type`.toInt, offset)
  ...
  override def glCopyTexSubImage3D(target: TextureTarget, level: Int, xoffset: Int, yoffset: Int, zoffset: Int, x: Int, y: Int, width: Int, height: Int): Unit =
    gl.copyTexSubImage3D(target.toInt, level, xoffset, yoffset, zoffset, x, y, width, height)
  ...
  override def glBlitFramebuffer(srcX0: Int, srcY0: Int, srcX1: Int, srcY1: Int, dstX0: Int, dstY0: Int, dstX1: Int, dstY1: Int, mask: ClearMask, filter: Int): Unit =
    gl.blitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask.toInt, filter)
  ...
  override def glBeginTransformFeedback(primitiveMode: PrimitiveMode): Unit =
    gl.beginTransformFeedback(primitiveMode.toInt)
  ...
  override def glBindBufferRange(target: BufferTarget, index: Int, buffer: Int, offset: Int, size: Int): Unit =
    gl.bindBufferRange(target.toInt, index, buffers(buffer), offset, size)

  override def glBindBufferBase(target: BufferTarget, index: Int, buffer: Int): Unit =
    gl.bindBufferBase(target.toInt, index, buffers(buffer))
  ...
  override def glVertexAttribIPointer(index: Int, size: Int, `type`: DataType, stride: Int, offset: Int): Unit =
    gl.vertexAttribIPointer(index, size, `type`.toInt, stride, offset)
  ...
  override def glCopyBufferSubData(readTarget: BufferTarget, writeTarget: BufferTarget, readOffset: Int, writeOffset: Int, size: Int): Unit =
    gl.copyBufferSubData(readTarget.toInt, writeTarget.toInt, readOffset, writeOffset, size)
  ...
  override def glDrawArraysInstanced(mode: PrimitiveMode, first: Int, count: Int, instanceCount: Int): Unit =
    gl.drawArraysInstanced(mode.toInt, first, count, instanceCount)

  override def glDrawElementsInstanced(mode: PrimitiveMode, count: Int, `type`: DataType, indicesOffset: Int, instanceCount: Int): Unit =
    gl.drawElementsInstanced(mode.toInt, count, `type`.toInt, indicesOffset, instanceCount)
