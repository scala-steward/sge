...
class AngleGL20(lookup: SymbolLookup) extends GL20 {
  ...
  override def glBindTexture(target: TextureTarget, texture: Int): Unit = _glBindTexture.invoke(target, texture)
  ...
  override def glTexImage2D(target: TextureTarget, level: Int, internalformat: Int, width: Pixels, height: Pixels, border: Int, format: PixelFormat, `type`: DataType, pixels: Buffer): Unit =
    _glTexImage2D.invoke(target, level, internalformat, width.toInt, height.toInt, border, format, `type`, bufAddr(pixels))
  ...
  override def glTexSubImage2D(target: TextureTarget, level: Int, xoffset: Pixels, yoffset: Pixels, width: Pixels, height: Pixels, format: PixelFormat, `type`: DataType, pixels: Buffer): Unit =
    _glTexSubImage2D.invoke(target, level, xoffset.toInt, yoffset.toInt, width.toInt, height.toInt, format, `type`, bufAddr(pixels))
  ...
  override def glCopyTexImage2D(target: TextureTarget, level: Int, internalformat: Int, x: Pixels, y: Pixels, width: Pixels, height: Pixels, border: Int): Unit =
    _glCopyTexImage2D.invoke(target, level, internalformat, x.toInt, y.toInt, width.toInt, height.toInt, border)
  ...
  override def glCopyTexSubImage2D(target: TextureTarget, level: Int, xoffset: Pixels, yoffset: Pixels, x: Pixels, y: Pixels, width: Pixels, height: Pixels): Unit =
    _glCopyTexSubImage2D.invoke(target, level, xoffset.toInt, yoffset.toInt, x.toInt, y.toInt, width.toInt, height.toInt)
  ...
  override def glCompressedTexImage2D(target: TextureTarget, level: Int, internalformat: Int, width: Pixels, height: Pixels, border: Int, imageSize: Int, data: Buffer): Unit =
    _glCompressedTexImage2D.invoke(target, level, internalformat, width.toInt, height.toInt, border, imageSize, bufAddr(data))
  ...
  override def glCompressedTexSubImage2D(target: TextureTarget, level: Int, xoffset: Pixels, yoffset: Pixels, width: Pixels, height: Pixels, format: PixelFormat, imageSize: Int, data: Buffer): Unit =
    _glCompressedTexSubImage2D.invoke(target, level, xoffset.toInt, yoffset.toInt, width.toInt, height.toInt, format, imageSize, bufAddr(data))

  private lazy val _glTexParameterf = h("glTexParameterf", FunctionDescriptor.ofVoid(I, I, F))
  override def glTexParameterf(target: TextureTarget, pname: Int, param: Float): Unit = _glTexParameterf.invoke(target, pname, param)

  private lazy val _glTexParameteri = h("glTexParameteri", FunctionDescriptor.ofVoid(I, I, I))
  override def glTexParameteri(target: TextureTarget, pname: Int, param: Int): Unit = _glTexParameteri.invoke(target, pname, param)

  private lazy val _glTexParameterfv = h("glTexParameterfv", FunctionDescriptor.ofVoid(I, I, P))
  override def glTexParameterfv(target: TextureTarget, pname: Int, params: FloatBuffer): Unit = _glTexParameterfv.invoke(target, pname, bufAddr(params))

  private lazy val _glTexParameteriv = h("glTexParameteriv", FunctionDescriptor.ofVoid(I, I, P))
  override def glTexParameteriv(target: TextureTarget, pname: Int, params: IntBuffer): Unit = _glTexParameteriv.invoke(target, pname, bufAddr(params))

  private lazy val _glGetTexParameterfv = h("glGetTexParameterfv", FunctionDescriptor.ofVoid(I, I, P))
  override def glGetTexParameterfv(target: TextureTarget, pname: Int, params: FloatBuffer): Unit = _glGetTexParameterfv.invoke(target, pname, bufAddr(params))

  private lazy val _glGetTexParameteriv = h("glGetTexParameteriv", FunctionDescriptor.ofVoid(I, I, P))
  override def glGetTexParameteriv(target: TextureTarget, pname: Int, params: IntBuffer): Unit = _glGetTexParameteriv.invoke(target, pname, bufAddr(params))

  private lazy val _glGenerateMipmap = h("glGenerateMipmap", FunctionDescriptor.ofVoid(I))
  override def glGenerateMipmap(target: TextureTarget): Unit = _glGenerateMipmap.invoke(target)

  // ─── Blend / Color / Depth / Stencil state ────────────────────────────────

  private lazy val _glBlendFunc = h("glBlendFunc", FunctionDescriptor.ofVoid(I, I))
  override def glBlendFunc(sfactor: BlendFactor, dfactor: BlendFactor): Unit = _glBlendFunc.invoke(sfactor, dfactor)
  ...
  override def glBlendEquation(mode: BlendEquation): Unit = _glBlendEquation.invoke(mode)
  ...
  override def glClear(mask: ClearMask): Unit = _glClear.invoke(mask)
  ...
  override def glDepthFunc(func: CompareFunc): Unit = _glDepthFunc.invoke(func)
  ...
  override def glStencilFunc(func: CompareFunc, ref: Int, mask: Int): Unit = _glStencilFunc.invoke(func, ref, mask)
  ...
  override def glStencilMaskSeparate(face: CullFace, mask: Int): Unit = _glStencilMaskSeparate.invoke(face, mask)

  private lazy val _glStencilOp = h("glStencilOp", FunctionDescriptor.ofVoid(I, I, I))
  override def glStencilOp(fail: StencilOp, zfail: StencilOp, zpass: StencilOp): Unit = _glStencilOp.invoke(fail, zfail, zpass)
  ...
  override def glEnable(cap: EnableCap): Unit = _glEnable.invoke(cap)

  private lazy val _glDisable = h("glDisable", FunctionDescriptor.ofVoid(I))
  override def glDisable(cap: EnableCap): Unit = _glDisable.invoke(cap)

  private lazy val _glIsEnabled = h("glIsEnabled", FunctionDescriptor.of(B, I))
  override def glIsEnabled(cap: EnableCap): Boolean = fromGlBool(_glIsEnabled.invoke(cap))

  private lazy val _glViewport = h("glViewport", FunctionDescriptor.ofVoid(I, I, I, I))
  override def glViewport(x: Pixels, y: Pixels, width: Pixels, height: Pixels): Unit = _glViewport.invoke(x.toInt, y.toInt, width.toInt, height.toInt)

  private lazy val _glScissor = h("glScissor", FunctionDescriptor.ofVoid(I, I, I, I))
  override def glScissor(x: Pixels, y: Pixels, width: Pixels, height: Pixels): Unit = _glScissor.invoke(x.toInt, y.toInt, width.toInt, height.toInt)

  private lazy val _glCullFace = h("glCullFace", FunctionDescriptor.ofVoid(I))
  override def glCullFace(mode: CullFace): Unit = _glCullFace.invoke(mode)
  ...
  override def glDrawArrays(mode: PrimitiveMode, first: Int, count: Int): Unit = _glDrawArrays.invoke(mode, first, count)
  ...
  override def glReadPixels(x: Pixels, y: Pixels, width: Pixels, height: Pixels, format: PixelFormat, `type`: DataType, pixels: Buffer): Unit =
    _glReadPixels.invoke(x.toInt, y.toInt, width.toInt, height.toInt, format, `type`, bufAddr(pixels))
  ...
  override def glRenderbufferStorage(target: Int, internalformat: Int, width: Pixels, height: Pixels): Unit =
    _glRenderbufferStorage.invoke(target, internalformat, width.toInt, height.toInt)
  ...
  override def glCreateShader(`type`: ShaderType): Int = _glCreateShader.invoke(`type`).asInstanceOf[Int]
