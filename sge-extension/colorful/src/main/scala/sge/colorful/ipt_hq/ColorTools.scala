...
/** Contains code for manipulating colors as `int` and packed `float` values in the IPT_HQ color space. IPT has more color manipulation in the IPT_HQ color space.
  */
object ColorTools {
  ...
  /** Checks whether the given IPT_HQ color (I, P, T, alpha) is in-gamut; if not, brings it inside. */
  ...
  /** Checks whether the given IPT_HQ packed float is in-gamut; if not, brings it inside. */
