 ...
 * Covenant-source-reference: com/github/tommyettinger/colorful/ipt_hq/GradientTools.java
...
/** Static methods for handling gradients of smoothly-changing colors, typically inside of ArrayBuffers. The intent is for the ArrayBuffer to be used as a sequence of packed float IPT_HQ colors. This
  * class does some special handling for IPT_HQ colors, limiting to the correct gamut.
  */
object GradientTools {

  /** Creates an ArrayBuffer gradient from the packed float IPT_HQ color `start` to `end`, taking the specified number of steps and using linear interpolation.
    */
  ...
  /** Appends a gradient between several packed float IPT_HQ colors provided in `chain`.
    */
