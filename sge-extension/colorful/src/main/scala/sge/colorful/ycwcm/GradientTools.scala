 ...
 * Covenant-source-reference: com/github/tommyettinger/colorful/ycwcm/GradientTools.java
...
/** Static methods for handling gradients of smoothly-changing colors, typically inside of ArrayBuffers. The intent is for the ArrayBuffer to be used as a sequence of packed float YCwCm colors.
  */
object GradientTools {

  /** Creates an ArrayBuffer gradient from the packed float YCwCm color `start` to `end`, taking the specified number of steps and using linear interpolation.
    */
  ...
  /** Appends a gradient between several packed float YCwCm colors provided in `chain`.
    */
