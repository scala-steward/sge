...
/** Data holder for a sprite that stores both a color and a tweak in the Oklab color space. The color is additive (affecting L, A, B channels) and the tweak is multiplicative (affecting L, A, B
