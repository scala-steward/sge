 ...
 * Covenant-source-reference: com/github/tommyettinger/colorful/ipt/GradientTools.java
...
/** Static methods for handling gradients of smoothly-changing colors, typically inside of ArrayBuffers. The intent is for the ArrayBuffer to be used as a sequence of packed float IPT colors.
  */
object GradientTools {

  /** Creates an ArrayBuffer gradient from the packed float IPT color `start` to `end`, taking the specified number of steps and using linear interpolation.
    */
  ...
  /** Appends a gradient between several packed float IPT colors provided in `chain`.
    */
