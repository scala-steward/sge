...
/** Data holder for a sprite that stores both a color and a tweak in the IPT color space. The color is additive (affecting I, P, T channels) and the tweak is multiplicative (affecting I, P, T
