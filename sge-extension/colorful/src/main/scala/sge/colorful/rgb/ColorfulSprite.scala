 ...
 * Original source: colorful/src/main/java/com/github/tommyettinger/colorful/rgb/ColorfulSprite.java
 ...
 * Covenant-source-reference: colorful/src/main/java/com/github/tommyettinger/colorful/rgb/ColorfulSprite.java
...
import sge.colorful.rgb.ColorfulBatch.*
...
class ColorfulSprite() extends TextureRegion {
  ...
  /** Sets the color used to tint this sprite. Default is {@link Palette#GRAY} , which makes no changes to the color. Use {@link ColorTools#rgb(float, float, float, float)} or a predefined color from
    * {@link Palette} if you don't have a color currently.
    *
    * @param color
    *   the packed float color used to add red, green, and blue to the current sprite, as well as the multiplier for alpha
    */
  ...
  /** Sets the color used to tint this sprite and the tweak that affects how that color will be treated.
    ...
    *   the packed float color used to add red, green, and blue to the current sprite, as well as the multiplier for alpha
    * @param tweak
    *   the packed float used to multiply red, green, and blue, as well as the setting for contrast
    */
  ...
  /** Sets the color used to tint this sprite and the tweak that affects how that color will be treated.
    *
    * @param redAdd
    *   how much red to add; darkest is 0f, neutral is 0.5f, lightest is 1f
    * @param greenAdd
    *   how much green to add; darkest is 0f, neutral is 0.5f, lightest is 1f
    * @param blueAdd
    *   how much blue to add; darkest is 0f, neutral is 0.5f, lightest is 1f
    * @param alphaMul
    *   how much to multiply alpha by; fully transparent is 0f, neutral is 1f
    * @param redMul
    *   how much source red should be multiplied by; eliminates at 0f, neutral is 0.5f, emphasizes at 1f
    * @param greenMul
    *   how much source green should be multiplied by; eliminates at 0f, neutral is 0.5f, emphasizes at 1f
    * @param blueMul
    *   how much source blue should be multiplied by; eliminates at 0f, neutral is 0.5f, emphasizes at 1f
    * @param contrast
    ...
    */
  def setTweakedColor(redAdd: Float, greenAdd: Float, blueAdd: Float, alphaMul: Float, redMul: Float, greenMul: Float, blueMul: Float, contrast: Float): Unit = {
    val color    = ColorTools.rgb(redAdd, greenAdd, blueAdd, alphaMul)
    val tweak    = ColorTools.rgb(redMul, greenMul, blueMul, contrast)
    val vertices = this._vertices
    vertices(C1) = color
    vertices(C2) = color
    vertices(C3) = color
  ...
  def setColor(red: Float, green: Float, blue: Float, alpha: Float): Unit = {
    val color    = ColorTools.rgb(red, green, blue, alpha)
    val vertices = this._vertices
    vertices(C1) = color
    vertices(C2) = color
    vertices(C3) = color
  ...
  def setTweak(red: Float, green: Float, blue: Float, contrast: Float): Unit = {
    val tweak    = ColorTools.rgb(red, green, blue, contrast)
    val vertices = this._vertices
    vertices(T1) = tweak
    vertices(T2) = tweak
    vertices(T3) = tweak
  ...
  /** Returns the color of this sprite.
    *
    * @return
    *   a packed float color used to add red, green, and blue to the current sprite, as well as the multiplier for alpha
    */
  def color: Float =
    _vertices(C1)
  ...
  /** Returns the multiplicative color tweaks used by this sprite, as a packed float with the same format as a color.
    *
    * @return
    *   a packed float used to multiply red, green, and blue, as well as the setting for contrast
    */
