 ...
 * Covenant-baseline-methods: Method,MixEffect,_mixFactor,mixFactor,mixFactor_,rebind,render
 * Covenant-source-reference: com/crashinvaders/vfx/effects/util/MixEffect.java
