 ...
 * Covenant-baseline-methods: VerticalFlowGroup,_prefHeight,_prefWidth,childArr,columnWidth,computeSize,i,invalidate,lastPrefHeight,layout,prefHeight,prefWidth,sizeInvalid,spacing,spacing_,x,y
 * Covenant-source-reference: com/kotcrab/vis/ui/layout/VerticalFlowGroup.java
