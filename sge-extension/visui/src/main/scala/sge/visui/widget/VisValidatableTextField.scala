 ...
 * Covenant-baseline-methods: LastValidFocusListener,VisValidatableTextField,_restoreLastValid,addValidator,beforeChangeEventFired,getValidators,isValidationEnabled,keyboardFocusChanged,lastValid,restoreFocusListener,restoreLastValid,restoreLastValidText,setRestoreLastValid,setValidationEnabled,this,validateInput,validationEnabled,validators
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/VisValidatableTextField.java
