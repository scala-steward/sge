 ...
 * Covenant-baseline-methods: SplitPaneCursorManager,clearCustomCursor,contains,currentCursor,exit,handleBoundsContains,mouseMoved,setCustomCursor,targetCursor,touchDown,touchDragged
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/internal/SplitPaneCursorManager.java
