 ...
 * Covenant-baseline-methods: SpinnerModel,bind,decrement,increment,text,textChanged,wrap,wrap_
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/spinner/SpinnerModel.java
