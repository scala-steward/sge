 ...
 * Covenant-baseline-methods: FileSuggestionPopup,changed,createSuggestions,getTrimmedName,iter,pathFieldKeyTyped,suggestions
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/file/internal/FileSuggestionPopup.java
