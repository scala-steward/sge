 ...
 * Covenant-baseline-methods: BusyBar,BusyBarStyle,draw,height,prefHeight,prefWidth,resetSegment,segment,segmentDeltaX,segmentOverflow,segmentWidth,segmentX,this
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/BusyBar.java
