 ...
 * Covenant-baseline-methods: FileTypeFilter,Rule,_rules,accept,addRule,allTypesAllowed,allTypesAllowed_,getDescription,getExtensions,getRules,this,toString
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/file/FileTypeFilter.java
