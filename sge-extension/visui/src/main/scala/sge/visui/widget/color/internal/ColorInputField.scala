 ...
 * Covenant-baseline-methods: ColorFieldValidator,ColorInputField,ColorInputFieldListener,NumberFilter,_value,acceptChar,changeValue,changed,getValue,keyTyped,keyboardFocusChanged,setValue,updateUI,validateInput
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/color/internal/ColorInputField.java
