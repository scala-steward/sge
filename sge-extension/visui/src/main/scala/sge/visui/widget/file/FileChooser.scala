 ...
 * Covenant-baseline-loc: 1589
 * Covenant-baseline-methods: DEFAULT_KEY,DefaultFileDeleter,DefaultFileFilter,DefaultFileIconProvider,FileChooser,FileDeleter,FileIconProvider,FileItem,FileSorting,HistoryPolicy,Mode,SHORTCUTS_COMPARATOR,SelectionMode,ShortcutItem,ShowBusyBarTask,ViewMode,_activeFileTypeRule,_chooserStyle,_defaultFileName,_fileDeleter,_fileFilter,_fileTypeFilter,_groupMultiSelectKey,_iconProvider,_ignoreChooserSelectionMode,_listener,_multiSelectKey,_multiSelectionEnabled,_nameLabel,_selectionMode,_showSelectionCheckboxes,_sorting,_sortingOrderAscending,_viewMode,_watchingFilesEnabled,accept,activeItemChanged,addFavorite,addListeners,addRecentDirectory,buildFileList,buttonBar,buttonTable,cancel,cancelButton,changed,chooserWinService,clearRecentDirectories,clicked,close,compare,confirmButton,createBottomButtons,createCenterContentPanel,createFileItem,createFileTextBox,createListeners,createShortcutsMainPanel,createToolbar,createViewModePopupMenu,currentDirectory,currentFiles,currentFilesMetadata,currentPath,dateFormat,defaultFileName_,delete,deselect,deselectAll,directoryChanged,dirsSuggestionPopup,draw,driveCheckerListeners,driveCheckerService,f,fadeOut,favoriteFolderButton,favoriteFolderButtonTooltip,favorites,fileFilter_,fileListAdapter,fileListBusyBar,fileListView,fileMenu,fileNameSuggestionPopup,fileScrollPaneTable,fileTypeLabel,fileTypeSelectBox,fileWatcherThread,files,filesListRebuildScheduled,finished,focusFileScrollPaneOnShow,focusGained,focusLost,focusSelectedFileTextFieldOnShow,folderNewButton,folderParentButton,get,getActiveFileTypeFilterRule,getAudioIcon,getBundleText,getChooserStage,getChooserStyle,getCurrentDirectory,getDefaultIcon,getDefaultStartingDirectory,getDirIcon,getFile,getFileFilter,getFileListFromSelected,getGridSize,getGroupMultiSelectKey,getHistoryStage,getIconProvider,getImageIcon,getItemId,getLabelText,getMode,getMultiSelectKey,getPdfIcon,getSelectionMode,getSizes,getSorting,getTextIcon,getViewMode,handleSelectClick,hasTrash,highlightFiles,historyManager,i,iconImage,ignoreChooserSelectionMode,ignoreChooserSelectionMode_,init,invalidate,invalidateChildHierarchy,isDirectory,isFavoriteFolderButtonVisible,isGridMode,isGroupMultiSelectKeyPressed,isIgnoreChooserSelectionMode,isMultiSelectKeyPressed,isMultiSelectionEnabled,isSaveLastDirectory,isShowSelectionCheckboxes,isSortingOrderAscending,isThumbnailMode,isThumbnailModesSupported,isViewModeButtonVisible,isWatchingFilesEnabled,iter,keyDown,keyTyped,keyboardFocusChanged,label,list,listDirExecutor,listDirFuture,listFilteredCurrentDirectory,mainSplitPane,maxDateLabelWidth,metadata,multiSelectionEnabled,multiSelectionEnabled_,nameLabel,notifyListenerAndCloseDialog,preferencesIO,provideIcon,rebuildFileList,rebuildFileRootsCache,rebuildShortcutsFavoritesPanel,rebuildShortcutsList,rebuildViewModePopupMenu,recentDirectories,refresh,reloadPreferences,removeFavorite,removeInvalidSelections,removed,rootMode,roots,run,saveLastDirectory,select,selectAll,selectCheckBox,selectGroup,selectShortcut,selectedFileTextField,selectedFiles,selectedItems,selectedShortcut,selectionFinished,selectionMode,selectionMode_,setCurrentPathFieldText,setDefaultFileName,setDefaultPrefsName,setDirectory,setFavoriteFolderButtonVisible,setFileDeleter,setFileFilter,setFileTypeFilter,setGroupMultiSelectKey,setIcon,setIconProvider,setIgnoreChooserSelectionMode,setLabelText,setListener,setMode,setMultiSelectKey,setMultiSelectionEnabled,setPrefsName,setRootName,setSaveLastDirectory,setSelectedFiles,setSelectionMode,setShowSelectionCheckboxes,setSorting,setSortingOrderAscending,setStage,setViewMode,setViewModeButtonVisible,setVisible,setWatchingFilesEnabled,setupDefaultScrollPane,setupGridGroup,shortcutsFavoritesPanel,shortcutsListRebuildScheduled,shortcutsMainPanel,shortcutsRootsPanel,shortcutsScrollPane,shortcutsScrollPaneTable,shortcutsTable,showBusyBarTask,showDialog,showFileDelDialog,showFileDeleteDialog,showNewDirDialog,showNewDirectoryDialog,showOverwriteQuestion,showRecentDirButton,showSelectionCheckboxes,showSelectionCheckboxes_,sizes,sortingOrderAscending_,startFileWatcher,stopFileWatcher,style,table,text,this,thread,toolbarTable,touchDown,touchUp,updateFavoriteFolderButton,updateFileTypeSelectBox,updateSelectedFileFieldText,userDesktop,userHome,userName,viewModeButton,viewModeChanged,viewModePopupMenu,yes
 * Covenant-source-reference: com/kotcrab/vis/ui/widget/file/FileChooser.java
...

    {
      ...
      if (viewMode.isThumbnailMode) {
        ...
        if (viewMode == ViewMode.DETAILS) {
          ...
          add(Nullable[Actor](sizeLabel)).right().padRight(if (isDirectory) 0f else 10f)
