 ...
 * Covenant-baseline-methods: BaseHighlighter,addRule,i,process,rules,word
 * Covenant-source-reference: com/kotcrab/vis/ui/util/highlight/BaseHighlighter.java
