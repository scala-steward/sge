 ...
 * Covenant-baseline-methods: ListAdapter,add,fillTable,get,indexOf,iterable,setItemClickListener,setListView,size
 * Covenant-source-reference: com/kotcrab/vis/ui/util/adapter/ListAdapter.java
