 ...
 * Covenant-baseline-methods: OneColumnTableBuilder,fillTable,iter,this
 * Covenant-source-reference: com/kotcrab/vis/ui/building/OneColumnTableBuilder.java
...
/** Ignores row() calls and builds table with all widgets put into one column.
  ...
  *   MJ
  */
class OneColumnTableBuilder(estimatedWidgetsAmount: Int, estimatedRowsAmount: Int, defaultWidgetPadding: Padding)
