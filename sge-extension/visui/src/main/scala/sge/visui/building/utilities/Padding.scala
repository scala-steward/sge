 ...
 * Covenant-baseline-methods: PAD_0,PAD_2,PAD_4,PAD_8,Padding,add,applyPadding,applySpacing,of,reverse,setPadding,setSpacing,subtract,this
 * Covenant-source-reference: com/kotcrab/vis/ui/building/utilities/Padding.java
...
class Padding(val top: Float, val left: Float, val bottom: Float, val right: Float) {
  ...
  /** @param horizontal
    *   will be set as left and right padding.
    * @param vertical
    *   will be set as top and bottom padding.
    */
