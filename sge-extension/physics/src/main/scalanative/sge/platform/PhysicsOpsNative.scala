 ...
 * Covenant-baseline-loc: 1011
 * Covenant-baseline-methods: PhysicsC,PhysicsOpsNative,bodyApplyForce,bodyApplyForceAtPoint,bodyApplyImpulse,bodyApplyImpulseAtPoint,bodyApplyTorque,bodyApplyTorqueImpulse,bodyEnableCcd,bodyGetAngle,bodyGetAngularDamping,bodyGetAngularVelocity,bodyGetDominanceGroup,bodyGetGravityScale,bodyGetInertia,bodyGetLinearDamping,bodyGetLinearVelocity,bodyGetLocalCenterOfMass,bodyGetMass,bodyGetPosition,bodyGetType,bodyGetVelocityAtPoint,bodyGetWorldCenterOfMass,bodyIsAwake,bodyIsCcdEnabled,bodyIsEnabled,bodyIsRotationLocked,bodyIsTranslationLockedX,bodyIsTranslationLockedY,bodyRecomputeMassProperties,bodyResetForces,bodyResetTorques,bodySetAngle,bodySetAngularDamping,bodySetAngularVelocity,bodySetDominanceGroup,bodySetEnabled,bodySetEnabledTranslations,bodySetFixedRotation,bodySetGravityScale,bodySetLinearDamping,bodySetLinearVelocity,bodySetPosition,bodySleep,bodyWakeUp,buf,buf1,buf2,bufF,castShape,colliderGetAabb,colliderGetActiveCollisionTypes,colliderGetActiveEvents,colliderGetActiveHooks,colliderGetCollisionGroups,colliderGetContactForceEventThreshold,colliderGetDensity,colliderGetFriction,colliderGetMass,colliderGetOneWayDirection,colliderGetParentBody,colliderGetPosition,colliderGetPositionWrtParent,colliderGetRestitution,colliderGetShapeType,colliderGetSolverGroups,colliderIsEnabled,colliderIsSensor,colliderSetActiveCollisionTypes,colliderSetActiveEvents,colliderSetActiveHooks,colliderSetCollisionGroups,colliderSetContactForceEventThreshold,colliderSetContactSkin,colliderSetDensity,colliderSetEnabled,colliderSetFriction,colliderSetMass,colliderSetOneWayDirection,colliderSetPositionWrtParent,colliderSetRestitution,colliderSetSensor,colliderSetSolverGroups,contactPairCount,contactPairPoints,copyCount,count,createBoxCollider,createCapsuleCollider,createCircleCollider,createDynamicBody,createFixedJoint,createHeightfieldCollider,createKinematicBody,createMotorJoint,createPolygonCollider,createPolylineCollider,createPrismaticJoint,createRevoluteJoint,createRopeJoint,createSegmentCollider,createSpringJoint,createStaticBody,createTriMeshCollider,createWorld,destroyBody,destroyCollider,destroyJoint,destroyWorld,hit,i,intersectShape,motorJointGetAngularOffset,motorJointGetCorrectionFactor,motorJointGetLinearOffset,motorJointGetMaxForce,motorJointGetMaxTorque,motorJointSetAngularOffset,motorJointSetCorrectionFactor,motorJointSetLinearOffset,motorJointSetMaxForce,motorJointSetMaxTorque,pollContactForceEvents,pollContactStartEvents,pollContactStopEvents,pollIntersectionStartEvents,pollIntersectionStopEvents,prismaticJointEnableLimits,prismaticJointEnableMotor,prismaticJointGetLimits,prismaticJointGetMaxMotorForce,prismaticJointGetMotorSpeed,prismaticJointGetTranslation,prismaticJointSetLimits,prismaticJointSetMaxMotorForce,prismaticJointSetMotorSpeed,projectPoint,queryAABB,queryPoint,rayCast,rayCastAll,result,revoluteJointEnableLimits,revoluteJointEnableMotor,revoluteJointGetAngle,revoluteJointGetLimits,revoluteJointGetMaxMotorTorque,revoluteJointGetMotorSpeed,revoluteJointIsLimitEnabled,revoluteJointSetLimits,revoluteJointSetMaxMotorTorque,revoluteJointSetMotorSpeed,ropeJointGetMaxDistance,ropeJointSetMaxDistance,sge_phys_body_apply_force,sge_phys_body_apply_force_at_point,sge_phys_body_apply_impulse,sge_phys_body_apply_impulse_at_point,sge_phys_body_apply_torque,sge_phys_body_apply_torque_impulse,sge_phys_body_enable_ccd,sge_phys_body_get_angle,sge_phys_body_get_angular_damping,sge_phys_body_get_angular_velocity,sge_phys_body_get_dominance_group,sge_phys_body_get_gravity_scale,sge_phys_body_get_inertia,sge_phys_body_get_linear_damping,sge_phys_body_get_linear_velocity,sge_phys_body_get_local_center_of_mass,sge_phys_body_get_mass,sge_phys_body_get_position,sge_phys_body_get_type,sge_phys_body_get_velocity_at_point,sge_phys_body_get_world_center_of_mass,sge_phys_body_is_awake,sge_phys_body_is_ccd_enabled,sge_phys_body_is_enabled,sge_phys_body_is_rotation_locked,sge_phys_body_is_translation_locked_x,sge_phys_body_is_translation_locked_y,sge_phys_body_recompute_mass_properties,sge_phys_body_reset_forces,sge_phys_body_reset_torques,sge_phys_body_set_angle,sge_phys_body_set_angular_damping,sge_phys_body_set_angular_velocity,sge_phys_body_set_dominance_group,sge_phys_body_set_enabled,sge_phys_body_set_enabled_translations,sge_phys_body_set_fixed_rotation,sge_phys_body_set_gravity_scale,sge_phys_body_set_linear_damping,sge_phys_body_set_linear_velocity,sge_phys_body_set_position,sge_phys_body_sleep,sge_phys_body_wake_up,sge_phys_cast_shape,sge_phys_collider_get_aabb,sge_phys_collider_get_active_collision_types,sge_phys_collider_get_active_events,sge_phys_collider_get_active_hooks,sge_phys_collider_get_collision_groups,sge_phys_collider_get_contact_force_event_threshold,sge_phys_collider_get_density,sge_phys_collider_get_friction,sge_phys_collider_get_mass,sge_phys_collider_get_one_way_direction,sge_phys_collider_get_parent_body,sge_phys_collider_get_position,sge_phys_collider_get_position_wrt_parent,sge_phys_collider_get_restitution,sge_phys_collider_get_shape_type,sge_phys_collider_get_solver_groups,sge_phys_collider_is_enabled,sge_phys_collider_is_sensor,sge_phys_collider_set_active_collision_types,sge_phys_collider_set_active_events,sge_phys_collider_set_active_hooks,sge_phys_collider_set_collision_groups,sge_phys_collider_set_contact_force_event_threshold,sge_phys_collider_set_contact_skin,sge_phys_collider_set_density,sge_phys_collider_set_enabled,sge_phys_collider_set_friction,sge_phys_collider_set_mass,sge_phys_collider_set_one_way_direction,sge_phys_collider_set_position_wrt_parent,sge_phys_collider_set_restitution,sge_phys_collider_set_sensor,sge_phys_collider_set_solver_groups,sge_phys_contact_pair_count,sge_phys_contact_pair_points,sge_phys_create_box_collider,sge_phys_create_capsule_collider,sge_phys_create_circle_collider,sge_phys_create_dynamic_body,sge_phys_create_fixed_joint,sge_phys_create_heightfield_collider,sge_phys_create_kinematic_body,sge_phys_create_motor_joint,sge_phys_create_polygon_collider,sge_phys_create_polyline_collider,sge_phys_create_prismatic_joint,sge_phys_create_revolute_joint,sge_phys_create_rope_joint,sge_phys_create_segment_collider,sge_phys_create_spring_joint,sge_phys_create_static_body,sge_phys_create_trimesh_collider,sge_phys_create_world,sge_phys_destroy_body,sge_phys_destroy_collider,sge_phys_destroy_joint,sge_phys_destroy_world,sge_phys_intersect_shape,sge_phys_motor_joint_get_angular_offset,sge_phys_motor_joint_get_correction_factor,sge_phys_motor_joint_get_linear_offset,sge_phys_motor_joint_get_max_force,sge_phys_motor_joint_get_max_torque,sge_phys_motor_joint_set_angular_offset,sge_phys_motor_joint_set_correction_factor,sge_phys_motor_joint_set_linear_offset,sge_phys_motor_joint_set_max_force,sge_phys_motor_joint_set_max_torque,sge_phys_poll_contact_force_events,sge_phys_poll_contact_start_events,sge_phys_poll_contact_stop_events,sge_phys_poll_intersection_start_events,sge_phys_poll_intersection_stop_events,sge_phys_prismatic_joint_enable_limits,sge_phys_prismatic_joint_enable_motor,sge_phys_prismatic_joint_get_limits,sge_phys_prismatic_joint_get_max_motor_force,sge_phys_prismatic_joint_get_motor_speed,sge_phys_prismatic_joint_get_translation,sge_phys_prismatic_joint_set_limits,sge_phys_prismatic_joint_set_max_motor_force,sge_phys_prismatic_joint_set_motor_speed,sge_phys_project_point,sge_phys_query_aabb,sge_phys_query_point,sge_phys_ray_cast,sge_phys_ray_cast_all,sge_phys_revolute_joint_enable_limits,sge_phys_revolute_joint_enable_motor,sge_phys_revolute_joint_get_angle,sge_phys_revolute_joint_get_limits,sge_phys_revolute_joint_get_max_motor_torque,sge_phys_revolute_joint_get_motor_speed,sge_phys_revolute_joint_is_limit_enabled,sge_phys_revolute_joint_set_limits,sge_phys_revolute_joint_set_max_motor_torque,sge_phys_revolute_joint_set_motor_speed,sge_phys_rope_joint_get_max_distance,sge_phys_rope_joint_set_max_distance,sge_phys_spring_joint_get_rest_length,sge_phys_spring_joint_set_params,sge_phys_spring_joint_set_rest_length,sge_phys_world_get_gravity,sge_phys_world_get_num_solver_iterations,sge_phys_world_set_gravity,sge_phys_world_set_num_additional_friction_iterations,sge_phys_world_set_num_internal_pgs_iterations,sge_phys_world_set_num_solver_iterations,sge_phys_world_step,springJointGetRestLength,springJointSetParams,springJointSetRestLength,totalFloats,worldGetGravity,worldGetNumSolverIterations,worldSetGravity,worldSetNumAdditionalFrictionIterations,worldSetNumInternalPgsIterations,worldSetNumSolverIterations,worldStep
