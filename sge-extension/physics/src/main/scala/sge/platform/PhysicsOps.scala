...
/** Physics operations for 2D rigid body simulation backed by Rapier2D.
  *
  * All methods use primitives and Long handles to Rust-side Rapier2D objects. Platform implementations delegate to Rust via Panama FFM (JVM) or C ABI (Native).
  */
