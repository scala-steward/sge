 ...
 * Covenant-baseline-methods: SteeringBehavior,calculateRealSteering,calculateSteering,enabled,getActualLimiter,limiter,newVector,owner
 * Covenant-source-reference: com/badlogic/gdx/ai/steer/SteeringBehavior.java
 *   Renames: `com.badlogic.gdx.ai.steer` -> `sge.ai.steer`
 *   Convention: split packages, Nullable instead of null, public vars where appropriate
 * Covenant: full-port
 * Covenant-baseline-spec-pass: 0
