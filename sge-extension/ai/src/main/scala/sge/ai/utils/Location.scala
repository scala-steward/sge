 ...
 * Covenant-baseline-methods: Location,angleToVector,newLocation,orientation,orientation_,position,vectorToAngle
 * Covenant-source-reference: com/badlogic/gdx/ai/utils/Location.java
 *   Renames: `com.badlogic.gdx.ai.utils` -> `sge.ai.utils`; `Vector` -> `sge.math.Vector`
 *   Convention: split packages
 * Covenant: full-port
 * Covenant-baseline-spec-pass: 0
