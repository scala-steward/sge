 ...
 * Covenant-baseline-methods: BranchTask,addChildToTask,branch,children,copyTo,getChild,getChildCount,i,reset
 * Covenant-source-reference: com/badlogic/gdx/ai/btree/BranchTask.java
