 ...
 * Covenant-baseline-methods: AStarSearch,end,getEnd,getPath,heap,isFinished,path,step,u,update
 * Covenant-source-reference: space/earlygrey/simplegraphs/algorithms/AStarSearch.java
