...
/**
 * Holds extension data from a GLTF JSON element.
 * In the original Java, this implements Json.Serializable and uses reflection-based
 * deserialization. In SGE we store the raw JSON and deserialize on demand.
 *
