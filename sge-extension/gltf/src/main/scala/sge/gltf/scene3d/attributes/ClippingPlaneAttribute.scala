 ...
 * Covenant-baseline-methods: ClippingPlaneAttribute,Type,TypeAlias,compare,copy,plane,this
 * Covenant-source-reference: net/mgsx/gltf/scene3d/attributes/ClippingPlaneAttribute.java
