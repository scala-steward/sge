 ...
 * Covenant-baseline-methods: MirrorSourceAttribute,Type,TypeAlias,compare,copy,normal,set,textureDescription
 * Covenant-source-reference: net/mgsx/gltf/scene3d/attributes/MirrorSourceAttribute.java
