 ...
 * Covenant-baseline-methods: BaseColorFactor,BaseColorFactorAlias,PBRColorAttribute,copy,createBaseColorFactor
 * Covenant-source-reference: net/mgsx/gltf/scene3d/attributes/PBRColorAttribute.java
