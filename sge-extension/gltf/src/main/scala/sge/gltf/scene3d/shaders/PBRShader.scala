 ...
 * Covenant-baseline-methods: PBRShader,PBRShaderUtils,allTextureTypes,baseColorFactorSetter,baseColorFactorUniform,baseColorTextureSetter,baseColorTextureUniform,bindLights,bindMaterial,brdfLUTTextureSetter,brdfLUTTextureUniform,canRender,cascadeCount,clippingPlaneSetter,clippingPlaneUniform,computeMorphTargetsMask,computeVertexColorLayers,countShadowCascades,csmPCFClip,csmTransforms,diffuseEnvTextureSetter,diffuseEnvTextureUniform,emissiveScaledColor,emissiveTextureSetter,emissiveTextureUniform,envRotationSetter,envRotationUniform,fogEquationSetter,fogEquationUniform,getTextureCoordinateMapMask,i,init,iorSetter,iorUniform,iridescenceFactorSetter,iridescenceFactorUniform,iridescenceIORSetter,iridescenceIORUniform,iridescenceTextureSetter,iridescenceTextureUniform,iridescenceThicknessMaxSetter,iridescenceThicknessMaxUniform,iridescenceThicknessMinSetter,iridescenceThicknessMinUniform,iridescenceThicknessTextureSetter,iridescenceThicknessTextureUniform,loc,mask,maskShift,mat3,metallicRoughnessSetter,metallicRoughnessTextureSetter,metallicRoughnessTextureUniform,metallicRoughnessUniform,mirrorNormalSetter,mirrorNormalUniform,morphTargetsFlag,morphTargetsMask,n,normalScaleSetter,normalScaleUniform,normalTextureSetter,normalTextureUniform,num,occlusionStrengthSetter,occlusionStrengthUniform,occlusionTextureSetter,occlusionTextureUniform,projViewTransSetter,projViewTransUniform,render,set,setFloat,setFloat3,setFloat4,setInt,shadowBiasSetter,shadowBiasUniform,specularColorFactorSetter,specularColorFactorUniform,specularColorTextureSetter,specularColorTextureUniform,specularEnvTextureSetter,specularEnvTextureUniform,specularFactorSetter,specularFactorTextureSetter,specularFactorTextureUniform,specularFactorUniform,specularMirrorMipmapSetter,specularMirrorMipmapUniform,specularMirrorTextureSetter,specularMirrorTextureUniform,tcmMask,textureCoordinateMapMask,textureTransform,thicknessFactorSetter,thicknessFactorUniform,thicknessTextureSetter,thicknessTextureUniform,transformTexture,transmissionFactorSetter,transmissionFactorUniform,transmissionSourceMipmapSetter,transmissionSourceMipmapUniform,transmissionSourceTextureSetter,transmissionSourceTextureUniform,transmissionTextureSetter,transmissionTextureUniform,u_BaseColorFactor,u_BaseColorTexture,u_DiffuseEnvSampler,u_EmissiveTexture,u_FogEquation,u_NormalScale,u_NormalTexture,u_ShadowBias,u_SpecularEnvSampler,u_ambientLight,u_brdfLUTTexture,u_clippingPlane,u_csmPCFClip,u_csmSamplers,u_csmTransforms,u_emissive,u_envRotation,u_ior,u_iridescenceFactor,u_iridescenceIOR,u_iridescenceTexture,u_iridescenceThicknessMax,u_iridescenceThicknessMin,u_iridescenceThicknessTexture,u_metallicRoughness,u_metallicRoughnessTexture,u_mipmapScale,u_morphTargets1,u_morphTargets2,u_occlusionStrength,u_occlusionTexture,u_specularColorFactor,u_specularColorTexture,u_specularFactor,u_specularFactorTexture,u_specularMirrorMipmapScale,u_specularMirrorNormal,u_specularMirrorSampler,u_texCoord0Transform,u_texCoord1Transform,u_thicknessFactor,u_thicknessTexture,u_transmissionFactor,u_transmissionSourceMipmap,u_transmissionSourceTexture,u_transmissionTexture,u_viewportInv,u_volumeColor,u_volumeDistance,v2,vertexAttributes,vertexColorLayers,viewportInvSetter,viewportInvUniform,volumeColorSetter,volumeColorUniform,volumeDistanceSetter,volumeDistanceUniform
 * Covenant-source-reference: net/mgsx/gltf/scene3d/shaders/PBRShader.java
