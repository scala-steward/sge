 ...
 * Covenant-baseline-methods: CrowdEffect,DEFAULT_ROTATION_STRENGTH,onApply,rot,rotationAmount
 * Covenant-source-reference: com/github/tommyettinger/textra/effects/CrowdEffect.java
