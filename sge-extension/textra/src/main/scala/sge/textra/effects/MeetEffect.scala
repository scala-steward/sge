 ...
 * Covenant-baseline-methods: DEFAULT_DISTANCE,MeetEffect,angle,dist,distance,interpolatedValue,interpolation,onApply,progress,random,random2,realExtent,timePassed,timePassedByGlyphIndex,x,y
 * Covenant-source-reference: com/github/tommyettinger/textra/effects/MeetEffect.java
