 ...
 * Covenant-baseline-methods: DEFAULT_DISTANCE,HighlightEffect,baseColor,onApply,saturation,shouldApply
 * Covenant-source-reference: com/github/tommyettinger/textra/effects/HighlightEffect.java
