...
import _root_.sge.{Input, Pixels, Sge}
import _root_.sge.assets.AssetManager
import _root_.sge.assets.loaders.FileHandleResolver
import _root_.sge.audio.{Sound, SoundId, Volume}
import _root_.sge.graphics.{ClearMask, Color, CompareFunc, CullFace, EnableCap, PerspectiveCamera, StencilOp, Texture}
import _root_.sge.graphics.g3d.attributes.IntAttribute
import _root_.sge.graphics.g3d.{Environment, Model, ModelBatch, ModelInstance}
import _root_.sge.graphics.g3d.environment.DirectionalLight
import _root_.sge.graphics.g2d.SpriteBatch
...
object AssetShowcaseGame extends DemoScene {
  ...
  override def init()(using Sge): Unit = {
    ...
    // 3D setup
    camera3d = PerspectiveCamera(67f, Sge().graphics.getWidth().toFloat, Sge().graphics.getHeight().toFloat)
    camera3d.near = 1f
    camera3d.far = 100f
