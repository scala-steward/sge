...
/** Abstract Activity that bootstraps an [[sge.AndroidApplication]] for a [[DemoScene]].
  *
  * Subclasses override [[scene]] to provide the demo to run. The Activity handles all Android lifecycle wiring: creates the ops provider, AndroidApplication, GL surface, and renderer bridge.
  *
