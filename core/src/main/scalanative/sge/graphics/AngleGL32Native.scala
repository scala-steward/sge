...
class AngleGL32Native extends AngleGL31Native with GL32 {
  ...
  override def glDrawElementsBaseVertex(mode: Int, count: Int, `type`: Int, indices: Buffer, basevertex: Int): Unit =
    GL32C.glDrawElementsBaseVertex(mode, count, `type`, bufPtr(indices), basevertex)
  ...
  override def glDrawRangeElementsBaseVertex(
    ...
    GL32C.glDrawRangeElementsBaseVertex(mode, start, end, count, `type`, bufPtr(indices), basevertex)
  ...
  override def glDrawElementsInstancedBaseVertex(
    ...
    GL32C.glDrawElementsInstancedBaseVertex(mode, count, `type`, bufPtr(indices), instanceCount, basevertex)
  ...
  override def glDrawElementsInstancedBaseVertex(
    ...
    GL32C.glDrawElementsInstancedBaseVertex(mode, count, `type`, offsetPtr(indicesOffset), instanceCount, basevertex)
  ...
  override def glReadnPixels(
    ...
    GL32C.glReadnPixels(x, y, width, height, format, `type`, bufSize, bufPtr(data))
  ...
  override def glTexParameterIiv(target: Int, pname: Int, params: IntBuffer): Unit =
    GL32C.glTexParameterIiv(target, pname, bufPtr(params).asInstanceOf[Ptr[CInt]])
  override def glTexParameterIuiv(target: Int, pname: Int, params: IntBuffer): Unit =
    GL32C.glTexParameterIuiv(target, pname, bufPtr(params).asInstanceOf[Ptr[CInt]])
  override def glGetTexParameterIiv(target: Int, pname: Int, params: IntBuffer): Unit =
    GL32C.glGetTexParameterIiv(target, pname, bufPtr(params).asInstanceOf[Ptr[CInt]])
  override def glGetTexParameterIuiv(target: Int, pname: Int, params: IntBuffer): Unit =
    GL32C.glGetTexParameterIuiv(target, pname, bufPtr(params).asInstanceOf[Ptr[CInt]])
  ...
  override def glTexBuffer(target: Int, internalformat: Int, buffer: Int): Unit =
    GL32C.glTexBuffer(target, internalformat, buffer)
  override def glTexBufferRange(target: Int, internalformat: Int, buffer: Int, offset: Int, size: Int): Unit =
    GL32C.glTexBufferRange(target, internalformat, buffer, offset, size)
  ...
  override def glTexStorage3DMultisample(
    ...
    GL32C.glTexStorage3DMultisample(target, samples, internalformat, width, height, depth, glBool(fixedsamplelocations))
}
