 ...
 *   TODO: typed GL enums -- GL31 opaque types for GL32 method params -- see docs/improvements/opaque-types.md
 *   Audited: 2026-03-03
 *
...
// String glGetObjectPtrLabel (long ptr);
  ...
  def glDrawElementsBaseVertex(mode: Int, count: Int, `type`: Int, indices: Buffer, basevertex: Int): Unit
  ...
  def glDrawRangeElementsBaseVertex(mode: Int, start: Int, end: Int, count: Int, `type`: Int, indices: Buffer, basevertex: Int): Unit
  ...
  def glDrawElementsInstancedBaseVertex(mode: Int, count: Int, `type`: Int, indices: Buffer, instanceCount: Int, basevertex: Int): Unit

  // C function void glDrawElementsInstancedBaseVertex ( GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei
  // instanceCount, GLint basevertex )

  def glDrawElementsInstancedBaseVertex(mode: Int, count: Int, `type`: Int, indicesOffset: Int, instanceCount: Int, basevertex: Int): Unit
...
// );
  ...
  def glReadnPixels(x: Int, y: Int, width: Int, height: Int, format: Int, `type`: Int, bufSize: Int, data: Buffer): Unit
...
// );
  ...
  def glTexParameterIiv(target: Int, pname: Int, params: IntBuffer): Unit
...
// );
  ...
  def glTexParameterIuiv(target: Int, pname: Int, params: IntBuffer): Unit
...
// );
  ...
  def glGetTexParameterIiv(target: Int, pname: Int, params: IntBuffer): Unit
...
// );
  ...
  def glGetTexParameterIuiv(target: Int, pname: Int, params: IntBuffer): Unit
...
// );
  ...
  def glTexBuffer(target: Int, internalformat: Int, buffer: Int): Unit

  // C function void glTexBufferRange ( GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size )

  def glTexBufferRange(target: Int, internalformat: Int, buffer: Int, offset: Int, size: Int): Unit
  ...
  def glTexStorage3DMultisample(target: Int, samples: Int, internalformat: Int, width: Int, height: Int, depth: Int, fixedsamplelocations: Boolean): Unit
}
